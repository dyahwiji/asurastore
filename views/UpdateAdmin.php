...
<table style="width:100%">
	...
	<?php foreach ($data as $y) { ?>
		<tr>
            ...
            <td align="center">
                <a href="<?php echo base_url()."AdminController/updateAdmin/".$y ['admin_name'];?>">Update Data</a>
            <br>
                <a href="<?php echo base_url()."AdminController/delete_admin/".$y ['admin_name'];?>">Delete Data</a>
            </td>
		</tr>
    <?php } ?>
    </tbody>
