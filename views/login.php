	...
	<div class="login">
		<div class="main-agileits">
				<div class="form-w3agile form1">
					<h3>Login</h3>
					<form method="post" action="<?php echo base_url()."UserController/oke"?>">
                ...
                <br><br>
                <label>Captcha: </label>
                <input type="text" name="nilaiCaptcha" class="login-field" value="" placeholder="captcha" id="login-captcha">
